...
// import all components and funcion
...
// Home page SpeechRecognitionResult(Top RTCTrackEvent, Upcoming, Trending movies)
    ...
    for (const [index, movie] of movieList.entries()) {
       ...
       <div class="banner-content">
           ...
           <a href="./detail.html" class="btn">
               <img src="./assets/img/play_circle.png"
               width="24" height="24" aria-hidden="true" alt="play circle">
